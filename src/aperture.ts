...
function play() {
  ...
  stage.innerHTML =
    ...
    `<g fill="url(#rx-ap-grad)" transform="translate(38 1590) scale(1 -1)"><path d="${R_PATH}"/><path d="${R_PATH}" transform="translate(2366 0) scale(-1 1)"/><path d="M 1183 862 Q 1229 780 1183 698 Q 1137 780 1183 862 Z"/></g>` +
    `</svg>`
