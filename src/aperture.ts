...
const SPARK_PATH =
  'M 1148 1155 L 1190 942 L 1310 900 L 1190 858 L 1148 645 L 1106 858 L 986 900 L 1106 942 Z'
...
function play() {
  ...
  stage.innerHTML =
    ...
    `<g fill="#FBF0C9" transform="translate(38 1590) scale(1 -1)"><path d="${SPARK_PATH}"/></g>` +
    `</svg>`
