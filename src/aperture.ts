...
function play() {
  ...
  stage.innerHTML =
    ...
    `<g fill="url(#rx-ap-grad)" transform="translate(38 1590) scale(1 -1)"><path d="${R_PATH}"/><path d="${R_PATH}" transform="translate(2366 0) scale(-1 1)"/><path d="M 1183 895 Q 1213 782 1183 675 Q 1153 782 1183 895 Z"/></g>` +
    `</svg>`
